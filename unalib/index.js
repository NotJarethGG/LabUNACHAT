export default {
  ...
  is_valid_phone: function (phone) {
    ...
    var re = /^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s./0-9]*$/i; // Eliminado el escape innecesario antes del punto
  ...
  is_valid_url_image: function (url) {
    ...
    var isValid = false;
    // expresion regular copiada de StackOverflow
    var re = /(http(s?):)([/|.|\w|\s|-])*\.(?:jpg|gif|png|jpeg|bmp)/i; // Eliminado el escape innecesario antes del punto
